...
\address
{Some details about you (e.g., 1st year M.Tech). \newline Note that you can make this span multiple lines. \newline Avoid giving personal details like your phone number and home address.}%
\email{author-one@autherone-inst.de}%
\date{the date}
